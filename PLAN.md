...
- [ ] Выбрать и подключить способ поиска (поисковая API или скрапинг в рамках правил использования).
- [ ] Реализовать поиск по категориям:
  - официальные сайты;
  - новостные сайты;
  - блоги;
  - исследования (научные/аналитические источники).
- [ ] Собирать кандидатов (URL + заголовок/сниппет) для передачи на этап сравнения; ограничить объём (например, топ-N по каждой категории).
