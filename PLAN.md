...
- [x] Подготовить промпт для AI: исходный текст/утверждения + список кандидатов-источников.
- [x] Запросить у модели сравнение **по смыслу** (не буквальное совпадение текста).
- [x] Парсить ответ AI: отобрать 1–3 лучших источника и оценку уверенности (например, проценты или уровни).
- [x] Сформировать текст ответа пользователю: список ссылок + краткая оценка уверенности.
- [x] С помощью AI проанализировать информацию в найденных источниках и сделать краткое резюме-заключение на предмет того, что утверждается во введённом тексте, и смысле того, о чём говорит статья. Добавить это резюме в ответ пользователю.
